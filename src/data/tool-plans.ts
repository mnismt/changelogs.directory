...
export const TOOL_PLANS: ToolPlanGroup[] = [
	{
		...
		plans: [
			...
			},
			{
				...
				priceUSD: 100,
				period: 'month',
				notes: 'Per seat, 5 seat minimum · $100 annual / $125 monthly',
		...
		gotchas: [
			...
			'June 15, 2026: Agent SDK / programmatic usage (claude -p, GitHub Actions) splits to separate monthly credits at API rates; interactive Claude Code stays on subscription limits.',
		],
	},
	{
		slug: 'codex',
		...
		plans: [
			{
				...
				priceUSD: 8,
				period: 'month',
				notes: 'Limited Codex · lightweight coding tasks',
				apiValueUSD: { typical: [8, 20], heavy: [20, 50] },
			},
			{
				name: 'ChatGPT Plus',
				priceUSD: 20,
			...
			},
			{
				...
				priceUSD: 100,
				period: 'month',
				notes: '5× Plus · incl. GPT-5.3-Codex-Spark',
				apiValueUSD: { typical: [125, 300], heavy: [400, 750] },
			},
			{
				name: 'ChatGPT Pro 20x',
				priceUSD: 200,
				period: 'month',
				notes: '20× Plus · incl. GPT-5.3-Codex-Spark',
			...
			},
			{
				...
				period: 'month',
				notes:
					'Per seat · $20 annual / $25 monthly · 2 seat min · Plus-level Codex per standard seat (usage-based Codex seats also available)',
		...
		gotchas: [
			...
			'ChatGPT Go ($8) is a new tier with limited Codex access — no published usage limits table.',
			'Business also offers a pay-as-you-go Codex-only workspace with no fixed seat fee.',
		],
	},
	{
		slug: 'gemini-cli',
		...
		plans: [
			...
			},
			{
				...
				priceUSD: 4.99,
				period: 'month',
				notes: '400 GB storage · Not supported for Gemini CLI quotas',
			...
			},
			{
				...
				priceUSD: 19.99,
				period: 'month',
				notes: '5 TB storage · 1,500 req/day in Gemini CLI',
			...
			},
			{
				...
				priceUSD: 99.99,
				period: 'month',
				notes: '5× Pro usage · 20 TB storage',
			...
			},
			{
				...
				priceUSD: 199.99,
				period: 'month',
				notes: '20× Pro usage · 30 TB storage (was $249.99)',
		...
		gotchas: [
			...
			'Google AI Plus dropped to $4.99/mo with 400 GB storage (Jun 9, 2026) but does NOT unlock Gemini CLI paid quotas — Pro/Ultra only.',
