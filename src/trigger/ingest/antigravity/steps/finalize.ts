...
export async function finalizeStep(
	...
	logger.info('Phase 7: Finalize Antigravity ingestion')
	...
	logger.info('Antigravity ingestion completed', {
		duration,
...
export async function handleFailure(
	...
	logger.error('Antigravity ingestion failed', { error: errorMessage })
